...
public class ICWServerMain {
    public static void main(String args[]) throws IOException {
        GameServer gameServer = new GameServer(new InetSocketAddress(5555), Files.find(Paths.get("scripts/"), 999, (path, bfa) -> bfa.isRegularFile() && path.toAbsolutePath().toString().endsWith(".js")).toArray(File[]::new));
        gameServer.run();
    }
}
